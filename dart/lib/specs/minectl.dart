...
final FigSpec minectlSpec = FigSpec(
      ...
      Subcommand(
          ...
          options: [
            Option(
                ...
                args: [
                  Arg(name: 'filename', template: ['filepaths'])
                ]),
            Option(
                name: ['--wait', '-w'],
      ...
      Subcommand(
          ...
          options: [
            Option(
                ...
                args: [
                  Arg(name: 'destination', template: ['folders'])
                ]),
            Option(
                name: ['--filename', '-f'],
                description: 'Location of the manifest file',
            ...
            Option(
                ...
                args: [
                  Arg(name: 'plugin', template: ['filepaths'])
                ]),
            Option(
                name: ['--ssh-key', '-k'],
                description: 'Specify a specific path for the SSH key',
                args: [Arg(name: 'ssh-ke')])
          ]),
      Subcommand(
          name: 'rcon',
      ...
      Subcommand(
          ...
          options: [
            Option(
                ...
                args: [
                  Arg(name: 'output', template: ['folders'])
                ])
          ]),
      Subcommand(
          name: 'help',
          ...
          subcommands: [
            ...
            Subcommand(name: 'list', description: 'List all Minecraft Server'),
            Subcommand(
                name: 'plugins',
                description: 'Manage your plugins for a specific server'),
            Subcommand(
    ...
    options: [
      ...
      Option(
          ...
          isPersistent: true,
          args: [
            Arg(name: 'log-encoding', defaultValue: 'console', suggestions: [
