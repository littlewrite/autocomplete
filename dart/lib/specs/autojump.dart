...
final FigSpec autojumpSpec = FigSpec(
    ...
    options: [
      ...
      Option(
          ...
          args: [
            Arg(name: 'directory', template: ['folders'])
          ]),
      Option(
          name: ['-i', '--increase'],
          description: 'Increase current directory weight',
          args: [Arg(name: 'weight')]),
      Option(
          name: ['-d', '--decrease'],
          description: 'Decrease current directory weight',
          args: [Arg(name: 'weight')]),
      Option(name: '--complete', description: 'Used for tab completion'),
      Option(
          name: '--purge',
      ...
      Option(name: ['-v', '--version'], description: 'Show version information')
    ]);
