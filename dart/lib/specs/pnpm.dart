...
final List<FigSubcommand> SUBCOMMANDS_MANAGE_DEPENDENCIES = [
  Subcommand(
      ...
      args: [
        Arg(name: 'package', generators: npmSearchGenerator, isVariadic: true)
      ],
      options: [
  ...
  Subcommand(
      ...
      options: [
        ...
        Option(name: '--global', description: 'Update global packages'),
        Option(
            name: ['-P', '--save-prod'],
            description:
  ...
  Subcommand(
      ...
      options: [
        ...
        Option(name: '--global', description: 'Remove a global package'),
        Option(
            name: ['-P', '--save-prod'],
...
// TS_UNCONVERTED_END
  ...
  Subcommand(
      ...
      args: [
        Arg(name: 'package', generators: generatorInstalledPackages)
      ],
      options: [
        Option(
            name: '--edit-dir',
  ...
  Subcommand(
      name: 'patch-remove', args: [Arg(name: 'package', isVariadic: true)])
];
...
// TS_UNCONVERTED_END
      ...
      options: [
        Option(
            ...
            args: [
              Arg(name: 'Audit Level', defaultValue: 'low', suggestions: [
        ...
        Option(
            name: '--json', description: 'Output audit report in JSON format'),
        Option(
            name: ['--dev', '-D'], description: 'Only audit dev dependencies'),
        Option(
            name: ['--prod', '-P'],
...
// TS_UNCONVERTED_END
            description: null),
        Option(name: '--json', description: 'Log output in JSON format'),
        Option(name: '--long', description: 'Show extended information'),
        Option(
            name: '--parseable',
            description:
...
// TS_UNCONVERTED_END
            ...
            args: [Arg(name: 'numbe')]),
        Option(
            name: ['--dev', '-D'], description: 'Only list dev dependencies'),
        Option(
            name: ['--prod', '-P'],
...
// TS_UNCONVERTED_END
            description: null),
        Option(name: '--long', description: 'Print details'),
        Option(name: '--global', description: 'List outdated global packages'),
        Option(
            name: '--no-table',
            description:
  ...
  Subcommand(
      ...
      options: [
        ...
        Option(name: '--json', description: 'Log output in JSON format'),
        Option(name: '--long', description: 'Show verbose output'),
        Option(
            name: '--parseable',
