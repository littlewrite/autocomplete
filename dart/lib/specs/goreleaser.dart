    ...
    subcommands: [
      Subcommand(
          ...
          options: [
            ...
            Option(
                ...
                args: [
                  Arg(name: 'config', template: ['filepaths'])
                ]),
            Option(
                name: '--deprecated',
                description:
            ...
            Option(
                ...
                args: [
                  Arg(name: 'output', template: ['filepaths'])
                ]),
            Option(
                name: ['--parallelism', '-p'],
                description:
                    'Amount tasks to run concurrently (default: number of CPUs)',
                args: [Arg(name: 'parallelism', defaultValue: '')]),
            Option(
                name: '--rm-dist',
                description: 'Remove the dist folder before building'),
            Option(
            ...
            Option(
                ...
                args: [Arg(name: 'timeout', defaultValue: '30m0')])
          ]),
      Subcommand(
          name: ['c', 'check'],
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(name: '--clean', description: 'Removes the dist folder'),
            Option(
                name: ['--config', '-f'],
                description: 'Load configuration from file',
                args: [
            ...
            Option(
                ...
                args: [
                  Arg(name: 'release-footer', template: ['filepaths'])
                ]),
            Option(
                ...
                args: [
                  Arg(name: 'release-footer-tmpl', template: ['filepaths'])
                ]),
            Option(
                name: '--release-header',
                description:
                ...
                args: [
                  Arg(name: 'release-header', template: ['filepaths'])
                ]),
            Option(
                ...
                args: [
                  Arg(name: 'release-header-tmpl', template: ['filepaths'])
                ]),
            Option(
                name: '--release-notes',
                description:
                ...
                args: [
                  Arg(name: 'release-notes', template: ['filepaths'])
                ]),
            Option(
                ...
                args: [
                  Arg(name: 'release-notes-tmpl', template: ['filepaths'])
                ]),
            Option(name: '--rm-dist', description: 'Removes the dist folder'),
            Option(
                name: '--skip',
                description:
            ...
            Option(name: '--skip-ko', description: 'Skips Ko builds'),
            Option(
                name: '--skip-publish',
                description:
                    'Skips publishing artifacts (implies --skip=announce)'),
            Option(
                name: '--skip-sbom', description: 'Skips cataloging artifacts'),
            Option(name: '--skip-sign', description: 'Skips signing artifacts'),
            Option(name: '--skip-validate', description: 'Skips git checks'),
            Option(
                name: '--snapshot',
                description:
