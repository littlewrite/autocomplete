...
final FigSpec tknSpec =
    FigSpec(name: 'tkn', description: 'CLI for tekton pipelines', subcommands: [
  Subcommand(
        ...
        Subcommand(
            ...
            options: [
              ...
              Option(
                  ...
                  args: [
                    Arg(name: 'cache-dir', defaultValue: '~/.tekton/bundle')
                  ]),
              Option(
                  name: '--no-cache',
                  description:
              ...
              Option(
                  ...
                  args: [
                    Arg(name: 'template', template: ['filepaths'])
                  ])
            ]),
        Subcommand(
            name: 'push',
  ...
  Subcommand(
      ...
      options: [
        Option(
            ...
            isPersistent: true,
            args: [
              Arg(name: 'chains-namespace', defaultValue: 'tekton-chain')
            ]),
        Option(
            name: ['--context', '-c'],
            description:
      ...
      subcommands: [
        ...
        Subcommand(
            ...
            options: [
              ...
              Option(name: ['--follow', '-f'], description: 'Stream live logs'),
              Option(
                  name: ['--last', '-L'],
        ...
        Subcommand(name: 'start', description: 'Start ClusterTasks', options: [
          Option(
              name: '--dry-run',
        ...
        Subcommand(
            ...
            options: [
              Option(
                  ...
                  args: [Arg(name: 'tail', defaultValue: '1')])
            ])
      ],
      options: [
        Option(
        ...
        Subcommand(
            ...
            options: [
              ...
              Option(
                  ...
                  description: 'Name of Catalog to which resource belongs',
                  isPersistent: true,
                  args: [Arg(name: 'from', defaultValue: 'tekto')]),
              Option(
                  name: ['--kubeconfig', '-k'],
                  description:
                      'Kubectl config file (default: \$HOME/.kube/config)',
        ...
        Subcommand(
            ...
            options: [
              ...
              Option(
                  ...
                  args: [Arg(name: 'match', defaultValue: 'contain')]),
              Option(
                  name: ['--output', '-o'],
                  description: 'Accepts output format: [table, json, wide]',
                  args: [Arg(name: 'output', defaultValue: 'tabl')]),
              Option(
                  name: '--platforms',
  ...
  Subcommand(
      ...
      subcommands: [
        ...
        Subcommand(name: 'export', description: 'Export Pipeline', options: [
          Option(
              name: '--allow-missing-template-keys',
              description:
                  'If true, ignore any errors in templates when a field or map key is missing in the template. Only applies to golang and jsonpath output formats'),
        ...
        Subcommand(name: 'logs', description: 'Show Pipeline logs', options: [
          Option(
              name: ['--all', '-a'],
              description:
                  'Show all logs including init steps injected by tekton'),
        ...
        Subcommand(name: 'sign', description: 'Sign Tekton Pipeline', options: [
          Option(
              name: '--allow-missing-template-keys',
              description:
                  'If true, ignore any errors in templates when a field or map key is missing in the template. Only applies to golang and jsonpath output formats'),
          Option(
              ...
              args: [Arg(name: 'file-nam')]),
          Option(
              name: ['--key-file', '-K'],
              description: 'Key file',
              args: [Arg(name: 'key-fil')]),
          Option(
              name: ['--kms-key', '-m'],
              description: 'KMS key url',
              args: [Arg(name: 'kms-ke')]),
          Option(
              name: ['--output', '-o'],
              description:
                  'Output format. One of: (json, yaml, name, go-template, go-template-file, template, templatefile, jsonpath, jsonpath-as-json, jsonpath-file)',
        ...
        Subcommand(name: 'start', description: 'Start Pipelines', options: [
          Option(
              name: '--dry-run',
          ...
          Option(
              ...
              isRepeatable: true,
              args: [Arg(name: 'task-serviceaccoun')]),
          Option(
              name: '--tasks-timeout',
              description: 'Timeout for Pipeline TaskRuns',
              args: [Arg(name: 'tasks-timeou')]),
          Option(
              name: '--timeout',
              description: 'Timeout for PipelineRun',
              args: [Arg(name: 'timeou')]),
  ...
  Subcommand(
      ...
      subcommands: [
        ...
        Subcommand(name: 'export', description: 'Export PipelineRun', options: [
          Option(
              name: '--allow-missing-template-keys',
              description:
                  'If true, ignore any errors in templates when a field or map key is missing in the template. Only applies to golang and jsonpath output formats'),
  ...
  Subcommand(
      ...
      subcommands: [
        ...
        Subcommand(name: 'logs', description: 'Show Task logs', options: [
          Option(
              name: ['--all', '-a'],
              description:
                  'Show all logs including init steps injected by tekton'),
        ...
        Subcommand(name: 'sign', description: 'Sign Tekton Task', options: [
          Option(
              name: '--allow-missing-template-keys',
              description:
                  'If true, ignore any errors in templates when a field or map key is missing in the template. Only applies to golang and jsonpath output formats'),
        ...
        Subcommand(name: 'start', description: 'Start Tasks', options: [
          Option(
              name: '--dry-run',
              description: 'Preview TaskRun without running it'),
          Option(
        ...
        Subcommand(name: 'verify', description: 'Verify Tekton Task', options: [
          Option(
              name: '--allow-missing-template-keys',
              description:
                  'If true, ignore any errors in templates when a field or map key is missing in the template. Only applies to golang and jsonpath output formats'),
  ...
  Subcommand(
      ...
      subcommands: [
        ...
        Subcommand(name: 'export', description: 'Export TaskRun', options: [
          Option(
              name: '--allow-missing-template-keys',
              description:
                  'If true, ignore any errors in templates when a field or map key is missing in the template. Only applies to golang and jsonpath output formats'),
        ...
        Subcommand(name: 'logs', description: 'Show TaskRuns logs', options: [
          Option(
              name: ['--all', '-a'],
              description:
                  'Show all logs including init steps injected by tekton'),
  ...
  Subcommand(name: 'help', description: 'Help about any command', subcommands: [
    Subcommand(
        name: ['tkb', 'bundles', 'bundle'],
        description: 'Manage Tekton Bundles',
        subcommands: [
    ...
    Subcommand(
        ...
        subcommands: [
          ...
          Subcommand(
              name: ['desc', 'describe'],
              description: 'Describe a ClusterTask'),
          Subcommand(name: ['ls', 'list'], description: 'Lists ClusterTasks'),
          Subcommand(name: 'logs', description: 'Show ClusterTask logs'),
          Subcommand(name: 'start', description: 'Start ClusterTasks')
        ]),
    Subcommand(
        name: ['ctb', 'clustertriggerbindings', 'clustertriggerbinding'],
        description: 'Manage ClusterTriggerBindings',
    ...
    Subcommand(
        ...
        subcommands: [
          ...
          Subcommand(
              name: ['ls', 'list'],
              description: 'Lists EventListeners in a namespace'),
          Subcommand(name: 'logs', description: 'Show EventListener logs')
        ]),
    Subcommand(
        name: 'hub',
        description: 'Interact with tekton hub',
    ...
    Subcommand(
        ...
        subcommands: [
          ...
          Subcommand(
              name: ['desc', 'describe'],
              description: 'Describes a Pipeline in a namespace'),
          Subcommand(name: 'export', description: 'Export Pipeline'),
          Subcommand(
              name: ['ls', 'list'],
              description: 'Lists Pipelines in a namespace'),
          Subcommand(name: 'logs', description: 'Show Pipeline logs'),
          Subcommand(name: 'sign', description: 'Sign Tekton Pipeline'),
          Subcommand(name: 'start', description: 'Start Pipelines'),
          Subcommand(name: 'verify', description: 'Verify Tekton Pipeline')
        ]),
    Subcommand(
        name: ['pr', 'pipelineruns', 'pipelinerun'],
        description: 'Manage PipelineRuns',
        subcommands: [
          ...
          Subcommand(
              name: ['desc', 'describe'],
              description: 'Describe a PipelineRun in a namespace'),
          Subcommand(name: 'export', description: 'Export PipelineRun'),
          Subcommand(
              name: ['ls', 'list'],
              description: 'Lists PipelineRuns in a namespace'),
          Subcommand(
    ...
    Subcommand(
        ...
        subcommands: [
          ...
          Subcommand(name: 'logs', description: 'Show Task logs'),
          Subcommand(name: 'sign', description: 'Sign Tekton Task'),
          Subcommand(name: 'start', description: 'Start Tasks'),
          Subcommand(name: 'verify', description: 'Verify Tekton Task')
        ]),
    Subcommand(
        name: ['tr', 'taskruns', 'taskrun'],
        description: 'Manage TaskRuns',
        subcommands: [
          ...
          Subcommand(
              name: ['desc', 'describe'],
              description: 'Describe a TaskRun in a namespace'),
          Subcommand(name: 'export', description: 'Export TaskRun'),
          Subcommand(
              name: ['ls', 'list'],
              description: 'Lists TaskRuns in a namespace'),
          Subcommand(name: 'logs', description: 'Show TaskRuns logs')
        ]),
    Subcommand(
        name: ['tb', 'triggerbindings', 'triggerbinding'],
        description: 'Manage TriggerBindings',
    ...
    Subcommand(name: 'version', description: 'Prints version information')
  ])
], options: [
  Option(
