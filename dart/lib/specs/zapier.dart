// AI-generated from TypeScript source: zapier.ts
...
final FigOption debugFlag = FigOption(
  name: ['-d', '--debug'],
...
final FigSpec zapierPlatformCliSpec = FigSpec(
    ...
    subcommands: [
      ...
      Subcommand(
          ...
          args: [
            Arg(name: 'version', description: 'The version to deprecate'),
            Arg(
                name: 'date',
                description:
      ...
      Subcommand(
          ...
          options: [debugFlag]),
      Subcommand(name: 'logs', description: 'Print recent logs', options: [
        Option(
            name: ['-v', '--version'],
      ...
      Subcommand(
          ...
          args: [
            Arg(name: 'version', description: 'The version you want promote')
          ]),
      Subcommand(
          name: 'push',
      ...
      Subcommand(
          ...
          options: [
            Option(
                ...
                args: [Arg(name: 'dest', template: 'folders')]),
            Option(
                name: '--test-dest',
                description:
          ...
          args: [
            Arg(name: 'actionType', suggestions: [
      ...
      Subcommand(
          ...
          options: [
            Option(
                name: ['-f', '--force'],
                description:
                    'Skip confirmation. Useful for running programmatically',
                isDangerous: true),
            debugFlag
          ],
          args: [
      ...
      Subcommand(
          ...
          args: [Arg(name: 'email', description: 'The user to be removed')]),
      Subcommand(
          name: 'validate',
