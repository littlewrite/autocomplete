// Auto-generated from TypeScript source: ai-platform.ts
// Generated at: 2026-02-12
// WARNING: Manual changes may be overwritten!

import 'package:autocomplete/src/spec.dart';

/// Completion spec for `ai-platform` CLI
final FigSpec aiPlatformSpec = FigSpec(
  name: 'ai-platform',
                ...
                Option(
                  ...
                  args: [
                    ...
                    suggestions: [
                      ...
                      FigSuggestion(name: 'premium-1'),
                      FigSuggestion(name: 'standard-1')
                    ]
                  )
                  ]
                ),
            ...
            Option(
              ...
              args: [
                ...
                suggestions: [
                  ...
                  FigSuggestion(name: 'australia-southeast1'),
                  FigSuggestion(name: 'europe-west1'),
                  FigSuggestion(name: 'europe-west2'),
                  FigSuggestion(name: 'europe-west3'),
                  FigSuggestion(name: 'europe-west4'),
                  FigSuggestion(name: 'northamerica-northeast1'),
                  FigSuggestion(name: 'us-central1'),
                  FigSuggestion(name: 'us-east1'),
                  FigSuggestion(name: 'us-east4'),
                  FigSuggestion(name: 'us-west1')
                ]
              )
              ]
            ),
