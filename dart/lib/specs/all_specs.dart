...
void registerAllSpecs() {
  ...
  registerSpec(preset_cli.presetSpec.name, () => preset_cli.presetSpec);
  registerSpec(
  ...
  registerSpec(claudeSpec.name, () => claudeSpec);
  ...
  registerSpec(codexSpec.name, () => codexSpec);
  ...
  registerSpec(geminiSpec.name, () => geminiSpec);
  ...
  registerSpec(httpsSpec.name, () => httpsSpec);
  ...
  registerSpec(preset.presetSpec.name, () => preset.presetSpec);
  ...
  registerSpec(qwenSpec.name, () => qwenSpec);
  ...
  registerSpec(rustroverSpec.name, () => rustroverSpec);
