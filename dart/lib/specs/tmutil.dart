...
final FigSpec tmutilSpec =
    FigSpec(name: 'tmutil', description: 'Time Machine utility', subcommands: [
  Subcommand(name: 'version', description: 'Print the current version'),
  Subcommand(
      name: 'enable',
      description:
  ...
  Subcommand(
      ...
      options: [
        ...
        Option(
            ...
            args: [Arg(name: 'destination i')])
      ]),
  Subcommand(
      name: 'stopbackup', description: 'Cancel a backup currently in progress'),
  Subcommand(
      name: 'delete',
      description:
      ...
      options: [
        Option(
            ...
            args: [Arg(name: 'backup mount poin')]),
        Option(
            name: '-t',
  ...
  Subcommand(name: 'compare', description: 'Perform a backup diff', args: [
    Arg(name: 'backup or path'),
    Arg(name: 'path (if not backup)', isOptional: true)
  ], options: [
    Option(name: '-@', description: 'Compare extended attributes'),
    Option(name: '-a', description: 'Compare all supported metadata'),
    Option(name: '-c', description: 'Compare creation times'),
    Option(name: '-d', description: 'Compare file data forks'),
    Option(name: '-e', description: 'Compare ACLs'),
    Option(name: '-f', description: 'Compare file flags'),
    Option(name: '-g', description: 'Compare GIDs'),
    Option(name: '-h', description: 'Unknown'),
    Option(name: '-l', description: 'Unknown'),
    Option(name: '-m', description: 'Compare file modes'),
    Option(name: '-n', description: 'No metadata comparison'),
    Option(name: '-s', description: 'Compare sizes'),
    Option(name: '-t', description: 'Compare modification times'),
    Option(name: '-u', description: 'Compare UIDs'),
    Option(
        name: '-E',
        description:
    ...
    Option(name: '-X', description: 'Print output in XML property list format'),
    Option(
        name: '-D',
        description:
  ...
  Subcommand(
      ...
      options: [
        Option(name: '-X', description: 'Print output in XML plist format')
      ]),
  Subcommand(
      name: 'addexclusion',
      description:
      ...
      options: [
        Option(name: '-p', description: 'Configure fixed-path exclusions'),
        Option(name: '-v', description: 'Configure volume exclusions')
      ]),
  Subcommand(
  ...
  Subcommand(
      ...
      args: [Arg(name: 'machine directory or sparsebundl')]),
  Subcommand(
      name: 'associatedisk',
      description:
      ...
      args: [
        Arg(name: 'mount point'),
        Arg(name: 'volume backup directory')
      ],
      options: [
        Option(
            name: '-a',
  ...
  Subcommand(
      ...
      args: [Arg(name: 'mount point or snapshot date')]),
  Subcommand(
      ...
      args: [
        Arg(name: 'mount point'),
        Arg(name: 'purge amount (bytes)', isOptional: true),
        Arg(name: 'urgency', isOptional: true, suggestions: [
