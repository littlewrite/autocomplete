// AI-generated from TypeScript source: argo.ts
...
// 添加 isPersistent 属性（对应 TypeScript 的 map 操作）
void makeOptionsPersistent() {
...
// 或者使用更简洁的方式：
List<Option> get persistentGlobalOptions => globalOptions.map((option) {
      return Option(
        name: option.name,
        description: option.description,
        isPersistent: true,
...
final FigSpec argoSpec = FigSpec(
    ...
    subcommands: [
          ...
          subcommands: [
            ...
            Subcommand(
                ...
                options: [
                  Option(
                      ...
                      args: [Arg(name: 'int')]),
                  Option(name: ['--help', '-h'], description: 'Help for list'),
                  Option(
                      name: ['--output', '-o'],
                      description:
                          'Output format. One of: json|yaml|wide (default "wide")',
            ...
            Subcommand(
                ...
                options: [
                  ...
                  Option(
                      name: ['--selector', '-l'], args: [Arg(name: 'string')])
                ]),
            Subcommand(
                name: 'resubmit',
                ...
                options: [
                  Option(
                      ...
                      args: [Arg(name: 'string')]),
                  Option(
                      name: ['--help', '-h'], description: 'Help for resubmit'),
                  Option(
                      name: '--log',
            ...
            Subcommand(
                ...
                options: [
                  Option(
                      ...
                      args: [Arg(name: 'string')]),
                  Option(name: ['--help', '-h'], description: 'Help for retry'),
                  Option(
                      name: '--log',
                      description: 'Log the workflow until it completes'),
                  Option(
      ...
      Subcommand(
          ...
          subcommands: [
            Subcommand(name: 'token', description: 'Print the auth token')
          ]),
      Subcommand(
          ...
          subcommands: [
            Subcommand(
                ...
                options: [
                  Option(
                      name: ['--help', '-h'], description: 'Help for create'),
                  Option(
                      name: ['--output', '-o'],
                      description: 'Output format. One of: name|json|yaml|wide',
                      args: [Arg(name: 'string')]),
                  Option(
                      name: '--strict',
                      description:
                          'Perform strict workflow validation (default true)')
                ]),
            Subcommand(
                name: 'delete',
                description: 'Delete a cluster workflow template',
                args: [
                  Arg(name: 'WORKFLOW_TEMPLATE')
                ],
                options: [
                  Option(
                      name: '--all',
                      description: 'Delete all cluster workflow templates'),
                  Option(name: ['--help', '-h'], description: 'Help for delete')
                ]),
            Subcommand(
                name: 'get',
                description:
                ...
                options: [
                  Option(name: ['--help', '-h'], description: 'Help for get'),
                  Option(
                      name: ['--output', '-o'],
            ...
            Subcommand(
                ...
                options: [
                  Option(name: ['--help', '-h'], description: 'Help for lint'),
                  Option(
                      name: ['--output', '-o'],
                      description:
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['--help', '-h'], description: 'Help for completion')
          ]),
      Subcommand(
          name: 'cp',
          ...
          options: [
            Option(
                ...
                args: [Arg(name: 'string')]),
            Option(name: ['--help', '-h'], description: 'Help for cp'),
            Option(
                name: '--node-id',
      ...
      Subcommand(name: 'cron', description: 'Manage cron workflows', options: [
        Option(name: '--help', description: 'Help for cron')
      ], subcommands: [
        Subcommand(
            name: 'create',
            description: 'Create a cron workflow',
            args: [
              Arg(name: 'FILE1 FILE2...')
            ],
            options: [
              Option(
                  name: '--entrypoint',
              ...
              Option(
                  ...
                  args: [Arg(name: 'string')]),
              Option(name: ['--help', '-h'], description: 'Help for create'),
              Option(
                  name: ['--labels', '-l'],
                  description:
        ...
        Subcommand(
            ...
            args: [
              Arg(name: '[CRON_WORKFLOW... | --all]')
            ],
            options: [
              Option(name: '--all', description: 'Delete all cron workflows'),
              Option(name: ['--help', '-h'], description: 'Help for delete')
            ]),
        Subcommand(
            name: 'get',
        ...
        Subcommand(name: 'list', description: 'List cron workflows', options: [
          Option(
          ...
          Option(
              ...
              args: [Arg(name: 'string')]),
          Option(
              name: '--resubmitted', description: 'Show resubmitted workflows'),
          Option(
              name: '--running',
              description:
        ...
        Subcommand(
            ...
            args: [Arg(name: 'CRON_WORKFLOW')]),
        Subcommand(
            name: 'suspend',
            description: 'Suspend zero or more cron workflows',
            args: [Arg(name: 'CRON_WORKFLOW')])
      ]),
      Subcommand(name: 'delete', description: 'Delete workflows', args: [
        Arg(name: 'WORKFLOW')
      ], options: [
        Option(name: '--all', description: 'Delete all workflows'),
        Option(
            name: ['--all-namespaces', '-A'],
            description: 'Delete workflows from all namespaces'),
        Option(name: '--completed', description: 'Delete completed workflows'),
        Option(
            name: '--dry-run',
            description:
        ...
        Option(
            ...
            args: [Arg(name: 'string')]),
        Option(
            name: '--resubmitted', description: 'Delete resubmitted workflows'),
        Option(
            name: ['--selector', '-l'],
            description:
                'Selector (label query) to filter on not including uninitialized ones supports \'=\'\'==\'and \'!=\'.(e.g. -l key1=value1,key2=value2)',
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['--help', '-h'], description: 'Help for get'),
            Option(name: '--no-color', description: 'Disable colorized output'),
            Option(
                name: '--no-utf8',
      ...
      Subcommand(name: 'help', description: 'Help about any command'),
      Subcommand(
          name: 'lint',
          ...
          options: [
            ...
            Option(
                ...
                args: [Arg(name: 'strings')]),
            Option(name: '--offline', description: 'Perform offline linting'),
            Option(
                name: ['--output', '-o'],
                description:
                    'Linting results output format. One of: pretty|simple (default "pretty")',
      ...
      Subcommand(name: 'list', description: 'List workflows', options: [
        Option(
            name: ['--all-namespaces', '-A'],
            description: 'Show workflows from all namespaces'),
        Option(
      ...
      Subcommand(
          ...
          args: [
            Arg(name: 'WORKFOW'),
            Arg(name: 'POD', isOptional: true)
          ],
          options: [
            Option(
                name: ['--container', '-c'],
                description:
                    'Print the logs of this container (default "main")',
                args: [Arg(name: 'string')]),
            Option(
                name: ['--follow', '-f'],
            ...
            Option(
                ...
                args: [Arg(name: 'string')]),
            Option(name: ['--help', '-h'], description: 'Help for logs'),
            Option(name: '--no-color', description: 'Disable colorized output'),
            Option(
                name: ['--previous', '-p'],
                description:
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['--help', '-h'], description: 'Help for node'),
            Option(
                name: ['--message', '-m'],
                description:
                    'Set the message of a node eg: --message "Hello World"',
                args: [Arg(name: 'string')]),
            Option(
                name: '--node-field-selector',
                description:
          ...
          options: [
            Option(
                ...
                description:
                    'Selector (field query) to filter on: supports \'=\' \'==\' and \'!=\'.(e.g. --field-selector key1=value1,key2=value2). The server only supports a limited number of field queries per type',
                args: [Arg(name: 'string')]),
            Option(name: ['--help', '-h'], description: 'Help for resubmit'),
            Option(
                name: '--log',
                description: 'Log the workflow until it completes'),
            Option(
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['--help', '-h'], description: 'Help for resume'),
            Option(
                name: '--node-field-selector',
                description:
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(
                name: '--api-rate-limit',
                description:
                    'Set limit per IP for api ratelimiter (default 1000)',
                args: [Arg(name: 'uint')]),
            Option(
                name: '--auth-mode',
                description:
            ...
            Option(
                name: ['-b', '--browser'],
                description:
                    'Enable automatic launching of the browser [local mode]'),
            Option(
                name: '--configmap',
                description:
            ...
            Option(
                ...
                args: [Arg(name: 'int')]),
            Option(name: ['-h', '--help'], description: 'Help for server'),
            Option(
                name: '--hsts',
                description:
            ...
            Option(
                ...
                args: [Arg(name: 'string')]),
            Option(name: '--namespaced', description: 'Run as namespaced mode'),
            Option(
                name: ['-p', '--port'],
          ...
          options: [
            ...
            Option(
                ...
                description:
                    'Selector (field query) to filter on  supports \'=\'  \'==\'  and \'!=\'.(e.g. --field-selector key1=value1,key2=value2). The server only supports a limited number of field queries per type',
                args: [Arg(name: 'string')]),
            Option(name: ['-h', '--help'], description: 'Help for stop'),
            Option(
                name: '--message',
      ...
      Subcommand(name: 'submit', description: 'Submit a workflow', args: [
        Arg(name: 'FILE...')
      ], options: [
        Option(
            name: '--dry-run',
        ...
        Option(
            ...
            args: [Arg(name: 'kind/name')]),
        Option(
            name: '--generate-name',
            description: 'Override metadata.generateName',
            args: [Arg(name: 'string')]),
        Option(name: ['-h', '--help'], description: 'Help for submit'),
        Option(
            name: ['-l', '--labels'],
            description:
                'Comma separated labels to apply to the workflow. Will override previous values',
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['-h', '--help'], description: 'Help for suspend')
          ]),
      Subcommand(
          name: 'template',
          description: 'Manipulate workflow templates',
          options: [
            Option(name: ['-h', '--help'], description: 'Help for template')
          ],
          subcommands: [
            Subcommand(
                name: 'create',
            ...
            Subcommand(
                ...
                options: [
                  ...
                  Option(name: ['-h', '--help'], description: 'Help for delete')
                ]),
            Subcommand(
                name: 'get',
                ...
                options: [
                  Option(name: ['-h', '--help'], description: 'Help for get'),
                  Option(
                      name: ['-o', '--output'],
                      args: [Arg(name: 'string')],
                      description: 'Output format. One of: json|yaml|wide')
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(
                ...
                args: [Arg(name: 'string')]),
            Option(name: ['-h', '--help'], description: 'Help for terminate'),
            Option(
                name: ['-l', '--selector'],
                description:
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['--help', '-h'], description: 'Help for version'),
            Option(
                name: '--short', description: 'Print just the version number')
          ]),
      Subcommand(
          name: 'wait',
          ...
          options: [
            Option(name: ['-h', '--help'], description: 'Help for wait'),
            Option(
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['-h', '--help'], description: 'Help for watch'),
            Option(
                name: '--node-field-selector',
                description:
                    'Selector of node to display eg: --node-field-selector phase=abc',
