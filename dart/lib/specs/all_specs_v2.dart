...
Future<void> ensureSpecLoadedV2(String command) async {
  ...
  switch (command) {
    ...
    case 'gcc':
      ...
      registerSpec(spec_gcc.gccSpec.name, () => spec_gcc.gccSpec);
      break;
    case 'gcloud':
    ...
    case 'lsof':
      ...
      registerSpec(spec_lsof.lsofSpec.name, () => spec_lsof.lsofSpec);
      break;
    case 'luz':
    ...
    case 'ng':
      ...
      registerSpec(spec_ng.ngSpec.name, () => spec_ng.ngSpec);
      break;
    case 'nginx':
    ...
    case 'nr':
      ...
      registerSpec(spec_nr.nrSpec.name, () => spec_nr.nrSpec);
      break;
    case 'nrm':
      await spec_nrm.loadLibrary();
      registerSpec(spec_nrm.nrmSpec.name, () => spec_nrm.nrmSpec);
      break;
    case 'ns':
    ...
    case 'z':
      ...
      registerSpec(spec_z.zSpec.name, () => spec_z.zSpec);
      break;
