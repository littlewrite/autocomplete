...
const List<String> v2SpecNamesFirstChar_a = ['access-context-manager', 'accessanalyzer', 'account', 'acm-pca', 'acr', 'act', 'active-directory', 'ad', 'adb', 'adp', 'adr', 'advisor', 'afd', 'afplay', 'aftman', 'ag', 'agrippa', 'ai-examples', 'ai-platform', 'airflow', 'aks', 'alerts-management', 'alexaforbusiness', 'alias', 'aliases', 'amlfs', 'amp', 'amplifybackend', 'amplifyuibuilder', 'ampx', 'ams', 'ansible', 'ansible-config', 'ansible-galaxy', 'ansible-lint', 'ansible-playbook', 'anthos', 'apigateway', 'apigatewaymanagementapi', 'apigatewayv2', 'apigee', 'apim', 'app', 'appconfig', 'appconfigdata', 'appfabric', 'appflow', 'appintegrations', 'application-autoscaling', 'application-insights', 'application-signals', 'applicationcostprofiler', 'appmesh', 'apprunner', 'appservice', 'appstream', 'appsync', 'apptest', 'apt', 'arc-zonal-shift', 'arcappliance', 'arcdata', 'arch', 'argo', 'aro', 'artifact', 'artifacts', 'asar', 'asciinema', 'asr', 'asset', 'astro', 'athena', 'atlas', 'attestation', 'auditmanager', 'auth', 'authchanger', 'autocannon', 'autojump', 'automanage', 'automation', 'autoscaling', 'autoscaling-plans', 'aws', 'aws-vault', 'awsume', 'az', 'azurestackhci'];
const List<String> v2SpecNamesFirstChar_b = ['b2bi', 'babel', 'backup', 'backup-gateway', 'backupstorage', 'banner', 'baremetalinstance', 'barnard59', 'base32', 'base64', 'basename', 'basenc', 'bat', 'batch', 'batchai', 'bazel', 'bc', 'bcd', 'bcm-data-exports', 'bcm-pricing-calculator', 'bedrock', 'bedrock-agent', 'bedrock-agent-runtime', 'bedrock-data-automation', 'bedrock-data-automation-runtime', 'bedrock-runtime', 'bicep', 'bigtable', 'billing', 'billing-benefits', 'billingconductor', 'bit', 'blitz', 'blockchain', 'blueprint', 'boards', 'bot', 'br', 'braket', 'brew', 'broot', 'browser-sync', 'btop', 'budgets', 'build', 'build-server', 'build-storybook', 'builds', 'bun', 'bundle', 'bunx', 'bw', 'bwdc', 'bws'];
const List<String> v2SpecNamesFirstChar_c = ['c++', 'cache', 'caffeinate', 'cal', 'cap', 'capacitor', 'capacity', 'cargo', 'cat', 'cci', 'cd', 'cdk', 'cdk8s', 'cdn', 'ce', 'cf', 'change-analysis', 'charm', 'chatbot', 'cheat-sheet', 'chime', 'chime-sdk-identity', 'chime-sdk-media-pipelines', 'chime-sdk-meetings', 'chime-sdk-messaging', 'chime-sdk-voice', 'chmod', 'chown', 'cicada', 'circleci', 'cl', 'clang', 'clang++', 'clean', 'cleanrooms', 'cleanroomsml', 'clear', 'cli', 'cli-translator', 'cliff-jumper', 'clilol', 'clojure', 'cloud', 'cloud-service', 'cloud-shell', 'cloud9', 'cloudcontrol', 'clouddirectory', 'cloudflared', 'cloudfront', 'cloudfront-keyvaluestore', 'cloudhsm', 'cloudhsmv2', 'cloudsearch', 'cloudsearchdomain', 'cloudtrail', 'cloudtrail-data', 'cmake', 'coda', 'code', 'code-insiders', 'codeartifact', 'codebuild', 'codecatalyst', 'codecommit', 'codeconnections', 'codeguru-reviewer', 'codeguru-security', 'codeguruprofiler', 'codepipeline', 'codesign', 'codestar', 'codestar-connections', 'codestar-notifications', 'cognitiveservices', 'cognito-identity', 'cognito-idp', 'cognito-sync', 'command', 'command-change', 'communication', 'components', 'composer', 'comprehend', 'comprehendmedical', 'compute', 'compute-optimizer', 'conda', 'confcom', 'confidentialledger', 'config', 'configservice', 'configure', 'confluent', 'connect', 'connect-contact-lens', 'connectcampaigns', 'connectcampaignsv2', 'connectcases', 'connectedk8s', 'connectedmachine', 'connectedvmware', 'connection', 'connectparticipant', 'consumption', 'container', 'containerapp', 'controlcatalog', 'controltower', 'copilot', 'copyfile', 'copypath', 'cosign', 'cosmosdb', 'cost-optimization-hub', 'costmanagement', 'cot', 'cp', 'create-completion-spec', 'create-next-app', 'create-nx-workspace', 'create-react-app', 'create-react-native-app', 'create-redwood-app', 'create-remix', 'create-t3-app', 'create-video', 'create-web3-frontend', 'croc', 'crontab', 'csdx', 'csvmware', 'cur', 'curl', 'custom-providers', 'customer-profiles', 'customlocation', 'cut', 'cw'];
const List<String> v2SpecNamesFirstChar_d = ['dart', 'data-catalog', 'databox', 'databoxedge', 'databrew', 'databricks', 'datadog', 'dataexchange', 'datafactory', 'dataflow', 'datamigration', 'datapipeline', 'dataproc', 'dataprotection', 'datashare', 'datastore', 'datasync', 'datazone', 'date', 'dateseq', 'datree', 'dax', 'dbt', 'dd', 'ddev', 'ddosify', 'deadline', 'debug', 'dedicated-hsm', 'demo', 'deno', 'deploy', 'deployctl', 'deployment', 'deployment-manager', 'deployment-scripts', 'desktopvirtualization', 'deta', 'detective', 'devcenter', 'devicefarm', 'devops', 'devops-guru', 'df', 'diff', 'dig', 'directconnect', 'direnv', 'dirname', 'discovery', 'disk', 'disk-access', 'disk-encryption-set', 'disk-pool', 'ditto', 'dla', 'dlm', 'dls', 'dms', 'dnc', 'dns', 'dns-resolver', 'do', 'do-release-upgrade', 'docdb', 'docdb-elastic', 'docker', 'docker-compose', 'doctl', 'dog', 'doggo', 'domains', 'dos2unix', 'dotenv', 'dotenv-vault', 'dotslash', 'dpkg', 'dprint', 'drs', 'ds', 'ds-data', 'dsql', 'dt', 'dtm', 'du', 'dust', 'dynamodb', 'dynamodbstreams', 'dynatrace'];
const List<String> v2SpecNamesFirstChar_e = ['eas', 'ebs', 'ec2-instance-connect', 'echo', 'ecr', 'ecr-public', 'edgeorder', 'efs', 'eks-auth', 'elastic', 'elastic-inference', 'elastic-san', 'elasticache', 'elastictranscoder', 'elb', 'elbv2', 'electron', 'eleventy', 'elif', 'elm', 'elm-format', 'elm-review', 'else', 'emacs', 'emr', 'emr-containers', 'emr-serverless', 'enapter', 'encore', 'endpoints', 'entityresolution', 'env', 'envchain', 'es', 'esbuild', 'eslint', 'eventgrid', 'eventhubs', 'events', 'evidently', 'exa', 'exec', 'exercism', 'export', 'extension', 'eza'];
const List<String> v2SpecNamesFirstChar_f = ['fastlane', 'fastly', 'fd', 'fdisk', 'feature', 'feedback', 'ffmpeg', 'figterm', 'file', 'filestore', 'fin', 'find', 'finspace', 'finspace-data', 'firebase', 'firefox', 'firehose', 'firestore', 'fis', 'fleet', 'fluid-relay', 'flutter', 'fms', 'fmt', 'fold', 'footprint', 'for', 'forc', 'forecast', 'forecastquery', 'format', 'frauddetector', 'freetier', 'fsx', 'functionapp', 'functions', 'fvm', 'fzf', 'fzf-tmux'];
const List<String> v2SpecNamesFirstChar_g = ['g++', 'game', 'gamelift', 'ganache-cli', 'gatsby', 'gcc', 'gcloud', 'gem', 'geo-maps', 'geo-places', 'geo-routes', 'ghq', 'git', 'git-quick-stats', 'git_push_example', 'github', 'glacier', 'globalaccelerator', 'glow', 'gltfjsx', 'glue', 'go', 'go-task', 'goctl', 'googler', 'goreleaser', 'goto', 'gradle', 'grafana', 'graph', 'graph-services', 'graphcdn', 'greengrass', 'greengrassv2', 'grep', 'grex', 'gron', 'groundstation', 'group', 'gt', 'guardduty', 'guestconfig'];
const List<String> v2SpecNamesFirstChar_h = ['hack', 'hanainstance', 'hardhat', 'hasura', 'hb-service', 'hdinsight', 'head', 'health', 'healthbot', 'healthcare', 'healthcareapis', 'healthlake', 'helm', 'helmfile', 'help', 'heroku', 'hexo', 'history', 'homey', 'honeycode', 'hop', 'hostname', 'hpc-cache', 'htop', 'http', 'http.server', 'httpy', 'hub', 'hugo', 'hx', 'hybridaks', 'hyper', 'hyperfine'];
const List<String> v2SpecNamesFirstChar_i = ['iam', 'iap', 'iconv', 'id', 'identity', 'identitystore', 'iex', 'if', 'image', 'imagebuilder', 'import-export', 'importexport', 'index', 'info', 'init', 'inspector', 'inspector-scan', 'inspector2', 'install', 'interactive', 'internet-analyzer', 'internetmonitor', 'invoicing', 'iot', 'iot-data', 'iot-jobs-data', 'iot1click-devices', 'iot1click-projects', 'iotanalytics', 'iotdeviceadvisor', 'iotevents', 'iotevents-data', 'iotfleethub', 'iotfleetwise', 'iotsecuretunneling', 'iotsitewise', 'iotthingsgraph', 'iottwinmaker', 'iotwireless', 'ivs', 'ivs-realtime', 'ivschat'];
const List<String> v2SpecNamesFirstChar_j = ['j', 'java', 'jenv', 'jest', 'jmeter', 'join', 'jq', 'julia', 'jupyter'];
const List<String> v2SpecNamesFirstChar_k = ['k3d', 'k6', 'k8s-configuration', 'k8s-extension', 'k8sconfiguration', 'k9s', 'kafka', 'kafkaconnect', 'kafkactl', 'kdoctor', 'kendra', 'kendra-ranking', 'keyspaces', 'keytool', 'keyvault', 'kill', 'killall', 'kind', 'kinesis', 'kinesis-video-archived-media', 'kinesis-video-media', 'kinesis-video-signaling', 'kinesis-video-webrtc-storage', 'kinesisanalytics', 'kinesisanalyticsv2', 'kinesisvideo', 'kitty', 'klist', 'kms', 'knex', 'kotlinc', 'kubecolor', 'kubectl', 'kubectx', 'kubens', 'kusto'];
const List<String> v2SpecNamesFirstChar_l = ['lab', 'lakeformation', 'laravel', 'launch-wizard', 'launchctl', 'ldd', 'leaf', 'less', 'lex-models', 'lex-runtime', 'lexv2-models', 'lexv2-runtime', 'license-manager', 'license-manager-linux-subscriptions', 'license-manager-user-subscriptions', 'lightsail', 'lima', 'list', 'ln', 'load', 'location', 'lock', 'locust', 'logging', 'logic', 'logicapp', 'login', 'logout', 'logs', 'logz', 'lookoutequipment', 'lookoutmetrics', 'lookoutvision', 'lp', 'lpass', 'ls', 'lsblk', 'lsd', 'luz', 'lvim'];
const List<String> v2SpecNamesFirstChar_m = ['m', 'm2', 'machinelearning', 'macie', 'macie2', 'mackup', 'maigret', 'mailmanager', 'mailsy', 'main', 'maintenance', 'make', 'managed-cassandra', 'managedapp', 'managedblockchain', 'managedblockchain-query', 'managedservices', 'managementpartner', 'maps', 'mariadb', 'marketplace-agreement', 'marketplace-catalog', 'marketplace-deployment', 'marketplace-entitlement', 'marketplace-reporting', 'marketplacecommerceanalytics', 'mas', 'mask', 'mdfind', 'mdls', 'mediaconnect', 'mediaconvert', 'medialive', 'mediapackage', 'mediapackage-vod', 'mediapackagev2', 'mediastore', 'mediastore-data', 'mediatailor', 'medical-imaging', 'memorydb', 'meroxa', 'mesh', 'meta', 'meteringmarketplace', 'mgh', 'mgn', 'micro', 'migrate', 'migration-hub-refactor-spaces', 'migrationhub-config', 'migrationhuborchestrator', 'migrationhubstrategy', 'mikro-orm', 'minectl', 'minikube', 'mix', 'mkdir', 'mkdocs', 'mkfifo', 'mknod', 'ml', 'ml-engine', 'mob', 'mobile', 'mobile-network', 'molecule', 'mongocli', 'mongoimport', 'mongosh', 'monitor', 'monitoring', 'more', 'mosh', 'mount', 'mq', 'msbuild', 'mturk', 'multipass', 'mv', 'mvn', 'mwaa', 'mypy', 'mysql'];
const List<String> v2SpecNamesFirstChar_n = ['n', 'nano', 'nativescript', 'nc', 'ncal', 'ncu', 'neofetch', 'neptune', 'neptune-graph', 'neptunedata', 'nest', 'netappfiles', 'netlify', 'network', 'network-firewall', 'network-function', 'network-management', 'networkcloud', 'networkfabric', 'networkflowmonitor', 'networkmanager', 'networkmonitor', 'new-relic', 'newman', 'next', 'nextflow', 'ng', 'nginx', 'ngrok', 'nhost', 'ni', 'nimble', 'nl', 'nmap', 'nocorrect', 'node', 'noglob', 'northflank', 'notification-hub', 'notifications', 'notificationscontacts', 'np', 'npm', 'npx', 'nr', 'nrm', 'ns', 'nu', 'nuxi', 'nuxt', 'nvim', 'nvm', 'nylas'];
const List<String> v2SpecNamesFirstChar_o = ['oam', 'observabilityadmin', 'oci', 'od', 'offazure', 'oh-my-posh', 'okta', 'ollama', 'omics', 'omz', 'onboardbase', 'opa', 'open', 'opensearch', 'opensearchserverless', 'opsworks', 'opsworks-cm', 'opsworkscm', 'orbital', 'organizations', 'osascript', 'osis', 'outposts'];
const List<String> v2SpecNamesFirstChar_p = ['pac', 'pack', 'pageres', 'palera1n', 'palo-alto', 'panorama', 'paper', 'partnercenter', 'partnercentral-selling', 'pass', 'passwd', 'paste', 'path', 'pathchk', 'payment-cryptography', 'payment-cryptography-data', 'pca-connector-ad', 'pca-connector-scep', 'pcs', 'pdfunite', 'peering', 'personalize', 'personalize-events', 'personalize-runtime', 'pg_dump', 'pgcli', 'php', 'phpunit', 'phpunit-watcher', 'pi', 'pijul', 'ping', 'pinpoint', 'pinpoint-email', 'pinpoint-sms-voice', 'pinpoint-sms-voice-v2', 'pip', 'pip3', 'pipelines', 'pipenv', 'pipes', 'pkg-config', 'pkgutil', 'pkill', 'planter', 'playwright', 'plutil', 'pm2', 'pmset', 'pnpm', 'pnpx', 'pocketbase', 'pod', 'podman', 'poetry', 'policy', 'policy-troubleshoot', 'polly', 'portal', 'postgres', 'powerbi', 'ppg', 'premake', 'preset', 'prettier', 'pricing', 'prisma', 'private-link', 'privatenetworks', 'pro', 'progressline', 'projects', 'proton', 'provider', 'providerhub', 'pry', 'ps', 'psql', 'publish', 'pubsub', 'purview', 'pushd', 'pwd', 'pyenv', 'pytest'];
const List<String> v2SpecNamesFirstChar_q = ['qapps', 'qbusiness', 'qconnect', 'qldb', 'qldb-session', 'qodana', 'quantum', 'quasar', 'quickmail', 'quicksight', 'qumulo', 'quota'];
const List<String> v2SpecNamesFirstChar_r = ['Rscript', 'railway', 'rake', 'ram', 'rbenv', 'rbin', 'rds', 'rds-data', 'readlink', 'recommender', 'redis', 'redisenterprise', 'redshift', 'redshift-data', 'redshift-serverless', 'rekognition', 'relay', 'remix', 'remote-rendering-account', 'remotion', 'repeat', 'repos', 'repostspace', 'reservations', 'resiliencehub', 'resource', 'resource-explorer-2', 'resource-groups', 'resource-manager', 'resource-mover', 'resourcegroupstaggingapi', 'resourcemanagement', 'rest', 'restore', 'restore-point', 'rg', 'rm', 'rmdir', 'robomaker', 'robot', 'rojo', 'role', 'rolesanywhere', 'rollup', 'rome', 'route53', 'route53-recovery-cluster', 'route53-recovery-control-config', 'route53-recovery-readiness', 'route53domains', 'route53profiles', 'route53resolver', 'rsync', 'ruby', 'ruff', 'rum', 'run', 'runtime.sagemaker', 'rushx', 'rustc', 'rvm'];
const List<String> v2SpecNamesFirstChar_s = ['s3control', 's3outposts', 's3tables', 'sagemaker', 'sagemaker-a2i-runtime', 'sagemaker-edge', 'sagemaker-featurestore-runtime', 'sagemaker-geospatial', 'sagemaker-metrics', 'sagemaker-runtime', 'sake', 'sam', 'sanity', 'sapmonitor', 'sapphire', 'savingsplans', 'scc', 'scenario', 'scheduler', 'schemas', 'scp', 'screen', 'scvmm', 'sdb', 'search', 'secrets', 'security', 'security-ir', 'securityhub', 'securitylake', 'sed', 'self-help', 'self-test', 'sentinel', 'seq', 'sequelize', 'serial-console', 'serve', 'serverless', 'serverlessrepo', 'service-quotas', 'servicebus', 'servicecatalog', 'servicecatalog-appregistry', 'servicediscovery', 'services', 'ses', 'sesv2', 'sf', 'sfdx', 'sftp', 'sha1sum', 'shasum', 'shelve', 'shield', 'shortcuts', 'shred', 'sidekiq', 'sig', 'signalr', 'signer', 'simctl', 'simspaceweaver', 'sips', 'site-recovery', 'sl', 'sls', 'sms', 'sms-voice', 'snapshot', 'snow-device-management', 'snowball', 'sns', 'socialmessaging', 'softwareupdate', 'sort', 'source', 'space', 'spanner', 'spatial-anchors-account', 'speedtest', 'speedtest-cli', 'sphere', 'splash-cli', 'split', 'spotify', 'spring', 'spring-cloud', 'sql', 'sqlfluff', 'sqlite3', 'sqlmesh', 'sqs', 'src', 'ssh', 'ssh-keygen', 'sshkey', 'ssm', 'ssm-contacts', 'ssm-incidents', 'ssm-quicksetup', 'ssm-sap', 'sso', 'sso-admin', 'sso-oidc', 'st2', 'sta', 'stack', 'stack-hci', 'starkli', 'start-storybook', 'stat', 'staticwebapp', 'steadybit', 'stencil', 'stepfunctions', 'storage', 'storage-mover', 'storagegateway', 'storagesync', 'store', 'stow', 'stream-analytics', 'streamlit', 'stripe', 'sts', 'su', 'subl', 'sudo', 'suitecloud', 'supabase', 'supplychain', 'support', 'support-app', 'surreal', 'survey', 'svn', 'svokit', 'sw_vers', 'swagger-typescript-api', 'swc', 'swf', 'swift', 'symfony', 'synapse', 'synthetics', 'sysctl'];
const List<String> v2SpecNamesFirstChar_t = ['tac', 'tag', 'tail', 'tailcall', 'tailwindcss', 'tangram', 'taplo', 'tar', 'task', 'tasks', 'taskwarrior', 'taxsettings', 'tb', 'tccutil', 'tee', 'term', 'textract', 'tfenv', 'then', 'time', 'timestream-influxdb', 'timestream-query', 'timestream-write', 'tkn', 'tldr', 'tmutil', 'tmux', 'tmuxinator', 'tns', 'tokei', 'top', 'topic', 'touch', 'tr', 'traceroute', 'transcribe', 'transfer', 'translate', 'trap', 'trash', 'tree', 'trex', 'truffle', 'truncate', 'trunk', 'trustedadvisor', 'ts', 'ts-node', 'tsc', 'tsi', 'tsx', 'tuist', 'turbo', 'twiggy', 'typeorm', 'typos', 'typst'];
const List<String> v2SpecNamesFirstChar_u = ['ua', 'ubuntu-advantage', 'uname', 'uniq', 'unix2dos', 'unset', 'until', 'unzip', 'upgrade', 'uv'];
const List<String> v2SpecNamesFirstChar_v = ['v', 'vale', 'vapor', 'vault', 'vela', 'vercel', 'verifiedpermissions', 'version', 'vi', 'vim', 'vimr', 'visudo', 'vite', 'vm', 'vmss', 'vmware', 'voice-id', 'volta', 'vpc-lattice', 'vr', 'vtex', 'vue'];
const List<String> v2SpecNamesFirstChar_w = ['w', 'waf', 'waf-regional', 'wafv2', 'wasm-bindgen', 'wasm-pack', 'watchman', 'wc', 'wd', 'webapp', 'webpack', 'webpubsub', 'wellarchitected', 'wezterm', 'wget', 'whence', 'where', 'whereis', 'which', 'while', 'who', 'whois', 'wifi-password', 'wing', 'wisdom', 'workdocs', 'worklink', 'workloads', 'workmail', 'workmailmessageflow', 'workspaces', 'workspaces-thin-client', 'workspaces-web', 'wp', 'wrangler', 'wrk', 'wscat'];
const List<String> v2SpecNamesFirstChar_x = ['xargs', 'xc', 'xcode-select', 'xcodebuild', 'xcodeproj', 'xcodes', 'xcrun', 'xdg-mime', 'xdg-open', 'xed', 'xray', 'xxd'];
