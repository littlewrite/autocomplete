// AI-generated from TypeScript source: webpack.ts
...
/// Completion spec for `webpack` CLI
final FigSpec webpackSpec =
    FigSpec(name: 'webpack', description: '', subcommands: [
  Subcommand(
      name: ['build', 'bundle', 'b'],
  ...
  Subcommand(
      name: ['help', 'h'], description: 'Display help for command and options'),
  Subcommand(
      name: ['info', 'i'],
  ...
  Subcommand(name: ['loader', 'l'], description: 'Scaffold a webpack loader'),
  Subcommand(name: ['plugin', 'p'], description: 'Scaffold a webpack plugin'),
  Subcommand(
      name: ['serve', 'server', 's'],
  ...
  Option(
      ...
      args: [Arg(name: 'value', isVariadic: true)]),
  Option(
      name: '--config-name',
  ...
  Option(name: '--no-hot', description: 'Disables Hot Module Replacement'),
  Option(
      name: '--analyze',
      description:
  ...
  Option(
      ...
      args: [Arg(name: 'value', isOptional: true)]),
  Option(name: '--no-amd', description: 'Negative \'amd\' option'),
  Option(
      name: '--bail',
      description:
          'Report the first error as a hard error instead of tolerating it'),
  Option(name: '--no-bail', description: 'Negative \'bail\' option'),
  Option(
      name: '--cache',
      description: 'Enable in memory caching. Disable caching'),
  Option(name: '--no-cache', description: 'Negative \'cache\' option'),
  Option(
  ...
  Option(
      ...
      args: [
        Arg(name: 'value', template: ['folders'])
      ]),
  Option(
  ...
  Option(
      ...
      args: [
        Arg(name: 'value', isVariadic: true, template: ['folders'])
      ]),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value')]),
  Option(name: '--no-devtool', description: 'Do not generate source maps'),
  Option(
      name: '--entry',
  ...
  Option(name: '--experiments-css', description: 'Enable css support'),
  Option(
  ...
  Option(name: '--experiments-layers', description: 'Enable module layers'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value', isOptional: true, isVariadic: true)]),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-generator-asset-data-url-encoding\' option'),
  Option(
  ...
  Option(
      ...
      args: [
        Arg(name: 'value', template: ['filepaths'])
      ]),
  Option(
  ...
  Option(
      ...
      args: [
        Arg(name: 'value', isOptional: true, template: ['filepaths'])
      ]),
  Option(
      name: '--no-module-parser-javascript-node-filename',
      description:
          'Negative \'module-parser-javascript-node-filename\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-require-context\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-require-ensure\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-require-include\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-auto-browserify\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-auto-commonjs\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-auto-require-js\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-dynamic-harmony\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-dynamic-import\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-dynamic-system\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-dynamic-worker\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-esm-browserify\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-esm-import-meta\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-esm-node-global\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'module-parser-javascript-esm-require-js\' option'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value')]),
  Option(name: '--no-node', description: 'Negative \'node\' option'),
  Option(
      name: '--node-dirname',
      description: 'Include a polyfill for the \'__dirname\' variable',
      args: [Arg(name: 'value', isOptional: true)]),
  ...
  Option(
      ...
      args: [Arg(name: 'value', isOptional: true)]),
  Option(
      name: '--no-node-global', description: 'Negative \'node-global\' option'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value')]),
  Option(name: '', description: 'Sets the name delimiter for created chunks'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'optimization-split-chunks-hide-path-info\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'optimization-split-chunks-used-exports\' option'),
  Option(
  ...
  Option(
      ...
      args: [
        Arg(name: 'value', template: ['filepaths', 'folders'])
      ]),
  Option(
  ...
  Option(
      name: '--no-output-iife', description: 'Negative \'output-iife\' option'),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'output-strict-module-exception-handling\' option'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value')]),
  Option(
      name: '--no-performance', description: 'Negative \'performance\' option'),
  Option(
  ...
  Option(name: '--no-profile', description: 'Negative \'profile\' option'),
  Option(
  ...
  Option(
      ...
      args: [
        Arg(name: 'value', isVariadic: true, template: ['filepaths'])
      ]),
  Option(
  ...
  Option(
      ...
      description:
          'Negative \'snapshot-resolve-build-dependencies-hash\' option'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value', isOptional: true)]),
  Option(name: '--no-stats', description: 'Disable stats output'),
  Option(
      name: '--stats-all',
      description:
          'Fallback value for stats options when an option is not defined (has precedence over local webpack defaults)'),
  Option(name: '--no-stats-all', description: 'Negative \'stats-all\' option'),
  Option(name: '--stats-assets', description: 'Add assets information'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value')]),
  Option(
      name: '--stats-built-at', description: 'Add built at time information'),
  Option(
  ...
  Option(name: '--stats-children', description: 'Add children information'),
  Option(
  ...
  Option(name: '--stats-chunks', description: 'Add chunk information'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value')]),
  Option(
      name: '--stats-colors', description: 'Enables/Disables colorful output'),
  Option(
  ...
  Option(
      name: '--stats-depth', description: 'Add module depth in module graph'),
  Option(
      name: '--no-stats-depth', description: 'Negative \'stats-depth\' option'),
  Option(
  ...
  Option(name: '--stats-env', description: 'Add --env information'),
  Option(name: '--no-stats-env', description: 'Negative \'stats-env\' option'),
  Option(
  ...
  Option(name: '--stats-errors', description: 'Add errors'),
  Option(
      name: '--no-stats-errors',
      description: 'Negative \'stats-errors\' option'),
  Option(name: '--stats-errors-count', description: 'Add errors count'),
  Option(
  ...
  Option(name: '--stats-hash', description: 'Add the hash of the compilation'),
  Option(
      name: '--no-stats-hash', description: 'Negative \'stats-hash\' option'),
  Option(name: '--stats-ids', description: 'Add ids'),
  Option(name: '--no-stats-ids', description: 'Negative \'stats-ids\' option'),
  Option(
      name: '--stats-logging',
      description:
  ...
  Option(name: '--stats-modules', description: 'Add built modules information'),
  Option(
  ...
  Option(
      name: '--stats-output-path', description: 'Add output path information'),
  Option(
      name: '--no-stats-output-path',
      description: 'Negative \'stats-output-path\' option'),
  Option(
      name: '--stats-performance', description: 'Add performance hint flags'),
  Option(
  ...
  Option(
      name: '--stats-public-path', description: 'Add public path information'),
  Option(
  ...
  Option(name: '--stats-source', description: 'Add the source code of modules'),
  Option(
      name: '--no-stats-source',
      description: 'Negative \'stats-source\' option'),
  Option(name: '--stats-timings', description: 'Add timing information'),
  Option(
  ...
  Option(
      name: '--stats-version', description: 'Add webpack version information'),
  Option(
      name: '--no-stats-version',
      description: 'Negative \'stats-version\' option'),
  Option(name: '--stats-warnings', description: 'Add warnings'),
  Option(
      name: '--no-stats-warnings',
      description: 'Negative \'stats-warnings\' option'),
  Option(name: '--stats-warnings-count', description: 'Add warnings count'),
  Option(
  ...
  Option(
      ...
      args: [Arg(name: 'value', isVariadic: true)]),
  Option(name: '--no-target', description: 'Negative \'target\' option'),
  Option(
      name: '--target-reset',
      description:
  ...
  Option(name: ['--watch', '-w'], description: 'Watch for files changes'),
  Option(name: '--no-watch', description: 'Do not watch for file changes'),
  Option(
