// AI-generated from TypeScript source: minikube.ts
    ...
    subcommands: [
      Subcommand(
          ...
          options: [
            ...
            Option(name: '--cni', description: 'CNI plug-in to use', args: [
              Arg(name: 'cni-plugin', suggestions: [
            ...
            Option(
                ...
                args: [
                  Arg(name: 'container-runtime', suggestions: [
            ...
            Option(
                ...
                args: [
                  Arg(
                      name: 'cpu number',
                      suggestions: [FigSuggestion(name: 'max')])
                ]),
            Option(
                name: '--cri-socket',
            ...
            Option(name: '--driver', description: 'Choose driver', args: [
              Arg(name: 'driver', suggestions: [
            ...
            Option(
                ...
                description:
                    'Location of the VPNKit socket used for networking'),
            Option(
            ...
            Option(
                ...
                description:
                    'The Kubernetes version that the minikube VM will use'),
            Option(
                name: '--kvm-gpu',
                description:
            ...
            Option(
                ...
                args: [
                  Arg(name: 'numa count', suggestions: [
            ...
            Option(
                name: '--network', description: 'Network to run minikube with'),
            Option(
                name: '--network-plugin',
            ...
            Option(name: '--ssh-ip-address', description: 'IP address'),
            Option(name: '--ssh-key', description: 'SSH key'),
            Option(name: '--ssh-port', description: 'SSH port'),
            Option(name: '--ssh-user', description: 'SSH user'),
            Option(name: '--trace', description: 'Send trace events', args: [
              Arg(name: 'trace', suggestions: [FigSuggestion(name: 'gcp')])
            ]),
            Option(
                name: '--uuid',
                description: 'Provide VM UUID to restore MAC address'),
            Option(name: '--vm', description: 'Filter to use only VM Drivers'),
            Option(
                name: '--wait',
                description:
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(name: ['--layout', '-l'], description: 'Output layout'),
            Option(
                name: ['--node', '-n'],
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(name: '--cancel-scheduled', description: 'Output layout'),
            Option(
            ...
            Option(
                name: '--schedule',
                description:
                    'Set flag to stop cluster after a set amount of time')
          ]),
      Subcommand(
          name: 'delete',
          ...
          options: [
            Option(
                name: '--all', description: 'Set flag to delete all profiles'),
            Option(
                name: '--purge',
                description:
                    'Set this flag to delete the \'.minikube\' folder from your user directory')
          ]),
      Subcommand(name: 'unpause', description: 'Unpause Kubernetes', options: [
        Option(
            name: ['--all-namespaces', '-A'],
            description: 'If set, unpause all namespaces'),
        Option(
            name: ['--namespaces', '-n'], description: 'Namespaces to unpause'),
        sharedOpts['output']!,
      ]),
      Subcommand(
          name: 'docker-env',
      ...
      Subcommand(
          ...
          subcommands: [
            Subcommand(name: 'add', description: 'Add an image to local cache'),
            Subcommand(
                name: 'delete',
            ...
            Subcommand(name: 'reload', description: 'Reload cached images')
          ]),
      Subcommand(name: 'image', description: 'Manage images', subcommands: [
        Subcommand(
            name: 'build', description: 'Build a container image in minikube'),
        Subcommand(name: 'load', description: 'Load a image into minikube'),
        Subcommand(name: 'ls', description: 'List images'),
        Subcommand(name: 'pull', description: 'Pull images'),
        Subcommand(name: 'push', description: 'Push images'),
        Subcommand(name: 'rm', description: 'Remove one or more images'),
        Subcommand(name: 'save', description: 'Save a image from minikube'),
        Subcommand(name: 'tag', description: 'Tag images')
      ]),
      Subcommand(
          name: 'addons',
          ...
          subcommands: [
            Subcommand(
                name: 'configure',
                description:
                    'Configures the addon w/ADDON_NAME within minikube'),
            Subcommand(
                name: 'disable',
      ...
      Subcommand(
          ...
          subcommands: [
            Subcommand(name: 'list', description: 'Lists all minikube profiles')
          ]),
      Subcommand(
          name: 'update-context',
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(name: '--namespace', description: 'The service namespace'),
            Option(
                name: '--url',
                description:
      ...
      Subcommand(
          ...
          options: [
            ...
            Option(
                name: '--port',
                description:
                    'Specify the port that the mount should be setup on'),
            Option(
                name: '--type',
                description:
      ...
      Subcommand(
          ...
          options: [
            Option(
                name: '--native-ssh',
                description: 'Use native Golang SSH client'),
            Option(name: ['--node', '-n'], description: 'The node to ssh into')
          ]),
      Subcommand(
          name: 'kubectl',
      ...
      Subcommand(
          ...
          subcommands: [
            Subcommand(
                name: 'add', description: 'Adds a node to the given cluster'),
            Subcommand(
                name: 'delete', description: 'Deletes a node from a cluster'),
            Subcommand(name: 'list', description: 'List nodes'),
            Subcommand(name: 'start', description: 'Starts a node'),
            Subcommand(name: 'stop', description: 'Stops a node in a cluster')
          ]),
      Subcommand(
          name: 'cp',
          description: 'Copy the specified file into minikube',
          args: [Arg(name: '[source] [target]')]),
      Subcommand(
          name: 'ssh-key',
          description:
      ...
      Subcommand(
          ...
          options: [
            Option(name: ['--node', '-n'], description: 'The node to get IP')
          ]),
      Subcommand(
          name: 'logs',
      ...
      Subcommand(
          ...
          subcommands: [
            Subcommand(name: 'bash', description: 'Bash completion'),
            Subcommand(name: 'fish', description: 'Fish completion'),
            Subcommand(name: 'zsh', description: 'Zsh completion')
          ])
    ]);
